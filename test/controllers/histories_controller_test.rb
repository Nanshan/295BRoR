...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { latitude: @history.latitude, like: @history.like, longitude: @history.longitude, userId: @history.userId }
    end
  ...
  test "should update history" do
    patch :update, id: @history, history: { latitude: @history.latitude, like: @history.like, longitude: @history.longitude, userId: @history.userId }
    assert_redirected_to history_path(assigns(:history))
  end
